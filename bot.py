...
def playBot():
	#bt2['state']='normal'
	#bt0['state']='disabled'
	#bt1.configure(bg='orange')
	wishMe()
	while True:
		#bt1.configure['orange']
		...
		if 'wikipedia' in query:
			...
			webbrowser.get('Path to Chrome.exe of your computer %s').open('https://www.youtube.com/')
			#webbrowser.open('youtube.com')

		elif 'google' in query:
			speak("Here you go to Google ")
			webbrowser.get('Path to Chrome.exe of your computer %s').open('https://www.google.com/')
			#webbrowser.open('youtube.com')
		
		elif 'coding blocks' in query:
			speak("Here you go to Coding Blocks")
			webbrowser.get('Path to Chrome.exe of your computer %s').open('https://online.codingblocks.com/')
			#webbrowser.open('youtube.com')

		elif 'open code' in query:
			codePath= "Path to VS code.exe of your computer"
			os.startfile(codePath)

		elif 'open java' in query:
			codeJava="Path to intellij.exe of your computer"
			os.startfile(codeJava)

		elif 'play music' in query:
			music_dir='C:\\saregaane'
